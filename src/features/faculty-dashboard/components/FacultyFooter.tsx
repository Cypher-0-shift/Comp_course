    ...
    <footer className="mt-auto border-t border-slate-800 bg-slate-900 py-4 px-6 text-xs text-slate-400">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 md:flex-row">
        <div className="flex items-center gap-2 text-slate-400">
          ...
          <span className="font-semibold text-slate-200">Faculty Portal</span>
          <span>&bull;</span>
          <span>&copy; {new Date().getFullYear()} Compensatory Course System</span>
        </div>
