...
import { LayoutDashboard, BookOpen, LogOut, Sparkles, Menu, X, ChevronDown, Users, PanelLeftClose, PanelLeftOpen, KeyRound, ShieldCheck } from 'lucide-react'
import { useAuth } from '@/shared/hooks/useAuth'
import { ChangePasswordModal } from '@/shared/components/ChangePasswordModal'

export function FacultyLayout() {
  const { user, signOut, availableRoles, switchRole, redirectToDashboard } = useAuth()
