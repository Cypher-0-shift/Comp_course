  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-6 flex h-6 w-6 items-center justify-center rounded-full border border-slate-700 bg-slate-900 text-slate-400 shadow-md transition hover:border-violet-500 hover:text-white"
      ...
      <div className={cn('flex items-center gap-3 px-4 py-5 border-b border-slate-800/60', collapsed && 'justify-center px-2')}>
        <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-violet-600/20 text-violet-400 ring-1 ring-violet-500/30">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-violet-600/90 text-white shadow-lg shadow-violet-950/60 ring-1 ring-violet-400/40'
