  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute -right-3 top-6 flex h-6 w-6 items-center justify-center rounded-full border border-slate-700 bg-slate-800 text-slate-300 shadow-md transition hover:border-violet-500 hover:text-white cursor-pointer"
